...
public class SignUpService {
    ...
    public String confirmToken(String token) {
        EmailToken emailToken = emailTokenService.getToken(token).orElseThrow(() -> new IllegalStateException("token not found"));
        ...
        userService.enableUser(emailToken.getUser().getEmail());
